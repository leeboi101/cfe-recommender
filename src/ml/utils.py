...
def export_ratings_dataset():
    ...
    return qs.values('uid','anime_uid','score') #will be a list of dic vals -> [{}]
...
# this all to export the models onto the default storage and convert it into
# a django file. This is incase later on I want to use something else other
# pickle, I would be able to.
